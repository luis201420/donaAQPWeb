...
<div class="content-wrapper">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h4 class="page-head-line">Eventos</h4>
        ...
        <div class="row">
            <div class="container ">
                <div class="panel panel-danger">
                    <div class="panel-heading "><h3>Proximos Eventos</h3>
                    </div>
                    <div class="panel-body" id="Proximos">
                    </div>
                </div>
                <div class="panel panel-danger">
                    <div class="panel-heading "><h3>Eventos Pasados</h3>
                    </div>
                ...
                for (var i = 1; i <= data[0]; i++) {
                    ...
                    if(actual<fecha){
                        $("#Proximos").append(
                            ...
                            '        <div class="panel-heading" data-toggle="collapse" data-target="#'+data[i]["idEventos"]+'"><h4><i class="fa fa-bell-o " style="margin-right:  15px;"></i><b>'+data[i]["Titulo"]+'</b><span class="label label-success" style="margin-left: 10px">'+data[i]["Fecha"]+'</span></h4></div>\n' +
                            '        <div class="collapse panel-body" id="'+data[i]["idEventos"]+'">' +
                            '           <h5>Lugar : '+data[i]["nombreCentro"]+'</h5>' +
                            '           <h5>Direccion : '+data[i]["Direccion"]+'</h5>' +
